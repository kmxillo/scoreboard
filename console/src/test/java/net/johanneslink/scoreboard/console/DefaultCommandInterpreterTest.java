...
class DefaultCommandInterpreterTest {
	...
	void interpretScore3() {
		assertEquals(interpreter.parse("3"), Action.SCORE_3);
		assertEquals(interpreter.parse("score 3"), Action.SCORE_3);
	}
	...
	@Test
	void interpretMinus1() {
		assertEquals(interpreter.parse("-"), Action.MINUS);
	}
